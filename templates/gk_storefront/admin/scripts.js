window.addEvent('domready', function(){
	...
	// overrides 
	['layout_override', 'suffix_override', 'module_override', 'mootools_for_pages', 'sidebar_width_for_pages'].each(function(txt) {
...
function getUpdates() {	
	...
	var update_url = 'https://www.gavick.com/updates/json/tmpl,component/query,product/product,gk_storefront_j25';
