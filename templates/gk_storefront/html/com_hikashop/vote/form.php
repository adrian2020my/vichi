...
?>
	...
	<p class="hikashop_form_comment"><?php echo JText::_('HIKASHOP_LET_A_COMMENT'); ?></p>
	<?php
	if (hikashop_loadUser() == "") { ?>
		<dl class="hikashop_comment_form">
			<dt class="hikashop_comment_form_name">
				<label><?php echo JText::_('HIKA_USERNAME').":"; ?></label>
			</dt>
			<dd>
		...
		if ($email_comment == 1) {
		?>
			<dt class="hikashop_comment_form_mail">
				<label><?php echo JText::_('HIKA_EMAIL').":"; ?></label>
			</dt>
			<dd>
