...
foreach ($this->cart->products as $pkey => $prow) {
	?>
<tr valign="top" class="<?php echo $i ?>">
	<td align="left">
...
<tr class="tablespace" valign="top" >
	...
	<?php /*	<td colspan="2" align="right"><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_SHIPPING'); ?> </td> */ ?>
				<td colspan="4" align="left">
				<small><?php echo $this->cart->cartData['shipmentName']; ?></small>
...
<tr class="tablespace" valign="top">
	...
	<td colspan="4" align="left">
		<small><?php echo $this->cart->cartData['paymentName']; ?></small>
...
<tr class="totalInPaymentCurrency">
