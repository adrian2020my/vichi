...
var MediaManager = this.MediaManager = {
	...
	initialize: function()
	{
		...
		this.tree = new MooTreeControl({ div: 'media-tree_tree', mode: 'folders', grid: true, theme: '../media/system/images/mootree.gif', onClick:
            ...
            },{ text: 'Bucket', open: true, data: { url: 'index.php?option=com_jaamazons3&view=localrepolist&tmpl=component', target: 'folderframe'}});
	...
	setViewType: function(type)
	{
		...
		viewstyle = type;
		var folder = this.getFolder();
        	this._setFrameUrl('index.php?option=com_jaamazons3&view=localrepolist&tmpl=component&folder='+folder+'&layout='+type);
	},
